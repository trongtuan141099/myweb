...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 06, 2026 lúc 04:32 PM
...
(1, 'PL15', 'PL01', '192.168.2.5', 'OFFLINE', 'Mất kết nối IoT', '2026-09-04 16:19:10'),
(2, 'PL15', 'PL16', '192.168.2.5', 'OFFLINE', 'Mất kết nối IoT', '2026-09-03 12:58:21'),
...
(34, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 12:49:35'),
(35, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 12:56:05'),
(36, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 12:57:37'),
(37, 'PL01', 'PL01', 'OFF', 'Thay đổi trạng thái', '2026-09-03 12:58:24'),
(38, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 12:58:29'),
(39, 'PL01', 'PL01', 'OFF', 'Thay đổi trạng thái', '2026-09-03 12:58:46'),
(40, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 12:58:53'),
(41, 'PL01', 'PL01', 'OFF', 'Thay đổi trạng thái', '2026-09-03 12:59:20'),
(42, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 12:59:23'),
(43, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:32:45'),
(44, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:32:56'),
(45, 'PL01', 'PL01', 'OFF', 'Thay đổi trạng thái', '2026-09-03 14:33:18'),
(46, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:33:23'),
(47, 'PL01', 'PL01', 'OFF', 'Thay đổi trạng thái', '2026-09-03 14:33:25'),
(48, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:33:27'),
(49, 'PL01', 'PL01', 'OFF', 'Thay đổi trạng thái', '2026-09-03 14:33:29'),
(50, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:33:31'),
(51, 'PL01', 'PL01', 'OFF', 'Thay đổi trạng thái', '2026-09-03 14:33:32'),
(52, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:33:34'),
(53, 'PL01', 'PL01', 'OFF', 'Thay đổi trạng thái', '2026-09-03 14:34:05'),
(54, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:34:08'),
(55, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:34:21'),
(56, 'PL01', 'PL01', 'ERROR', 'Thay đổi trạng thái', '2026-09-03 14:34:27'),
(57, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:34:31'),
(58, 'PL01', 'PL01', 'OFF', 'Thay đổi trạng thái', '2026-09-03 14:34:34'),
(59, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:34:38'),
(60, 'PL01', 'PL01', 'OFF', 'Thay đổi trạng thái', '2026-09-03 14:34:43'),
(61, 'PL01', 'PL01', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:34:55'),
(62, 'PL01', 'PL15', 'OFF', 'Thay đổi trạng thái', '2026-09-03 14:35:09'),
(63, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:35:11'),
(64, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:53:11'),
(65, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:53:31'),
(66, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:53:36'),
(67, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:56:26'),
(68, 'PL01', 'PL15', 'OFF', 'Thay đổi trạng thái', '2026-09-03 14:57:39'),
(69, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:57:44'),
(70, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:57:54'),
(71, 'PL01', 'PL15', 'ERROR', 'Thay đổi trạng thái', '2026-09-03 14:58:14'),
(72, 'PL01', 'PL15', 'OFF', 'Thay đổi trạng thái', '2026-09-03 14:58:19'),
(73, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:58:21'),
(74, 'PL01', 'PL15', 'ERROR', 'Thay đổi trạng thái', '2026-09-03 14:58:24'),
(75, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 14:58:26'),
(76, 'PL01', 'PL15', 'OFF', 'Thay đổi trạng thái', '2026-09-03 15:05:17'),
(77, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 15:05:20'),
(78, 'PL01', 'PL15', 'ERROR', 'Thay đổi trạng thái', '2026-09-03 15:05:23'),
(79, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 15:05:29'),
(80, 'PL01', 'PL15', 'ERROR', 'Thay đổi trạng thái', '2026-09-03 15:05:36'),
(81, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 15:05:44'),
(82, 'PL01', 'PL15', 'OFF', 'Thay đổi trạng thái', '2026-09-03 15:05:47'),
(83, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 15:05:53'),
(84, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 15:23:01'),
(85, 'PL01', 'PL15', 'OFF', 'Thay đổi trạng thái', '2026-09-03 15:23:04'),
(86, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 15:23:07'),
(87, 'PL01', 'PL15', 'OFF', 'Thay đổi trạng thái', '2026-09-03 15:23:17'),
(88, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 15:23:21'),
(89, 'PL01', 'PL15', 'OFF', 'Thay đổi trạng thái', '2026-09-03 15:24:25'),
(90, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 15:24:29'),
(91, 'PL01', 'PL15', 'ERROR', 'Thay đổi trạng thái', '2026-09-03 15:24:32'),
(92, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 15:24:36'),
(93, 'PL01', 'PL15', 'OFF', 'Thay đổi trạng thái', '2026-09-03 15:24:38'),
(94, 'PL01', 'PL15', 'ON', 'Thay đổi trạng thái', '2026-09-03 15:24:40');
...
--
-- Cấu trúc bảng cho bảng `extrusion_actual_logs`
--

CREATE TABLE `extrusion_actual_logs` (
  `id` int(11) NOT NULL,
  ...
  `mfg_order_code` varchar(50) DEFAULT NULL,
  `product_code` varchar(50) NOT NULL,
  `pipe_size` varchar(20) NOT NULL,
  `cost_center` varchar(50) DEFAULT NULL,
  `process_name` varchar(50) DEFAULT NULL,
  `device_code` varchar(50) DEFAULT NULL,
  `finished_qty_m` decimal(12,2) DEFAULT 0.00,
  `finished_qty_kg` decimal(12,2) DEFAULT 0.00,
  `ng_qty_kg` decimal(12,2) DEFAULT 0.00,
  `hard_waste_qty_kg` decimal(12,2) DEFAULT 0.00,
  `total_weight_kg` decimal(12,2) DEFAULT 0.00,
  `material_code` varchar(50) DEFAULT NULL,
  `regrind_count` int(11) DEFAULT 0,
  `regrind_package_code` varchar(50) DEFAULT NULL,
  `lot_in` varchar(100) DEFAULT NULL,
  `total_downtime` decimal(10,2) DEFAULT 0.00,
  `total_runtime` decimal(10,2) DEFAULT 0.00,
  `cycle_time` int(11) DEFAULT 0,
  `machine_efficiency` decimal(5,2) DEFAULT 0.00,
  `mold_code` varchar(50) DEFAULT NULL,
  `spider_code` varchar(50) DEFAULT NULL,
  `production_order_code` varchar(100) DEFAULT NULL,
  `is_test` tinyint(4) DEFAULT 0,
  `material_type` varchar(50) DEFAULT NULL,
  `material_ng_qty` decimal(10,2) DEFAULT 0.00,
  `lot_material_ng` varchar(50) DEFAULT NULL,
  `hdpe_qty` decimal(10,2) DEFAULT 0.00,
  `lio_clean_qty` decimal(10,2) DEFAULT 0.00,
  `ti_clean_qty` decimal(10,2) DEFAULT 0.00,
  `bobbin_pl7_3_count` int(11) DEFAULT 0,
  `bobbin_pl7_3_meters` decimal(12,2) DEFAULT 0.00,
  `bobbin_pl4_7_count` int(11) DEFAULT 0,
  `bobbin_pl4_7_meters` decimal(12,2) DEFAULT 0.00,
  `printer_type` varchar(50) DEFAULT NULL,
  `ink_type` varchar(50) DEFAULT NULL,
  `waiting_machine_count` int(11) DEFAULT 0,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(29, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', '2026-08-23 11:18:49', '2026-09-05 16:45:14'),
...
(32, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', '2026-08-24 12:18:52', '2026-09-05 16:45:03'),
...
(35, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', '2026-08-25 16:45:01', '2026-09-05 16:43:48'),
...
(39, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', '2026-08-25 23:51:35', '2026-09-05 14:08:03'),
...
(57, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', '2026-08-29 06:52:14', '2026-09-05 14:02:21'),
...
(69, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-03 12:58:16', NULL),
(70, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-04 13:40:52', NULL),
(71, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-04 14:14:49', '2026-09-04 23:17:48'),
(72, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-04 16:17:51', '2026-09-05 14:08:36'),
(73, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-05 00:20:25', '2026-09-05 07:24:06'),
(74, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-05 00:24:07', '2026-09-05 07:55:56'),
(75, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-05 00:56:06', '2026-09-05 14:01:46'),
(76, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-05 02:59:40', '2026-09-05 10:01:22'),
(77, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-05 03:01:24', '2026-09-05 13:45:27'),
(78, 3, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '2026-09-05 06:54:58', '2026-09-05 13:58:58');
...
--
-- Cấu trúc bảng cho bảng `production_actuals`
--
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `fullname`, `phone`, `status`, `role`, `created_at`, `updated_at`, `last_login`) VALUES
(1, 'admin', 'admin@myweb.com', 'admin', 'Admin User', '', 'active', 'admin', '2026-08-18 14:32:03', '2026-09-05 03:48:59', '2026-09-05 07:24:07'),
(3, 'user', 'user@gmail.com', 'user', 'User', '', 'active', 'viewer', '2026-08-18 14:32:03', '2026-09-05 06:54:58', '2026-09-05 13:54:58');
...
--
-- Chỉ mục cho bảng `extrusion_actual_logs`
--
ALTER TABLE `extrusion_actual_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `production_date` (`production_date`),
  ADD KEY `pipe_size` (`pipe_size`);
...
--
-- Chỉ mục cho bảng `production_actuals`
--
ALTER TABLE `production_actuals`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_actual_date` (`year_month`,`pipe_size`,`day`),
...
ALTER TABLE `production_plans`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_plan_date` (`year_month`,`pipe_size`,`day`),
  ADD KEY `year_month` (`year_month`),
  ADD KEY `pipe_size` (`pipe_size`);
...
--
-- AUTO_INCREMENT cho bảng `extrusion_actual_logs`
--
ALTER TABLE `extrusion_actual_logs`
...
--
-- AUTO_INCREMENT cho bảng `production_actuals`
--
ALTER TABLE `production_actuals`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
