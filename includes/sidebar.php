<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-menu">
    ...
    <div class="has-submenu open">
      <a href="dashboard.php" class="menu-item menu-parent <?= in_array($currentPage, [ 'dashboard.php', 'production_planing.php', 'yield.php']) ? 'active' : '' ?>">
      ...
      <div class="submenu">
        <a href="production_planing.php" class="submenu-item <?= $currentPage == 'production_planing.php' ? 'active' : '' ?>">
          <span class="material-icons sub-icon">tune</span>
          <span class="label">Kế hoạch sản xuất</span>
        </a>
        <a href="yield.php" class="submenu-item <?= $currentPage == 'yield.php' ? 'active' : '' ?>">
    ...
    <div class="has-submenu open">
      <a href="hrdashboard.php" class="menu-item menu-parent <?= in_array($currentPage, ['hrdashboard.php', 'employeelist.php', 'hrchart.php']) ? 'active' : '' ?>">
      ...
      <!-- Danh sách chỉ mục con -->
      <div class="submenu">
        <a href="employeelist.php" class="submenu-item <?= $currentPage == 'employeelist.php' ? 'active' : '' ?>">
          <span class="material-icons sub-icon">people</span>
          <span class="label">Danh sách nhân viên</span>
        </a>
        <a href="#" class="submenu-item <?= $currentPage == 'hrchart.php' ? 'active' : '' ?>">
    ...
    <div class="has-submenu open">
      <a href="document_admin.php" class="menu-item menu-parent <?= in_array($currentPage, ['document_admin.php', 'document_viewer.php']) ? 'active' : '' ?>">
